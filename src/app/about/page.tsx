          ...
          <section>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="bg-gray-900 p-6 rounded-lg">
                <div className="flex justify-between items-baseline mb-1">
                  ...
                  <span className="text-muted-foreground">NOV 2023 - DÉC 2023</span>
                </div>
            ...
            <Button asChild variant="link" className="mt-6 text-emerald-500">
              <Link href="/about/work-experiences">
                View all work experiences <ArrowRight className="ml-2 h-4 w-4"/>
              </Link>
            </Button>
          </section>
          <section>
            ...
            <div className="bg-gray-900 p-6 rounded-lg">
              <div className="flex justify-between items-baseline mb-2">
                <h3 className="text-2xl font-semibold">BTS SIO - Lycée Gaston Berger, Lille</h3>
                <span className="text-emerald-500 text-sm">EN COURS</span>
              </div>
              <p className="text-gray-300">1ère année de BTS Services Informatiques aux Organisations</p>
              <p className="text-gray-300">2ème année de BTS Services Informatiques aux Organisations</p>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="bg-gray-900 p-6 rounded-lg">
                ...
                <ul className="list-none text-gray-300 space-y-2">
                  <li>🌐 Développer la présence en ligne d&#39;une organisation</li>
                  <li>📋 Travailler en mode projet</li>
                  <li>💻 Développer, adapter et maintenir des solutions applicatives</li>
                  <li>🎯 Polyvalent</li>
                </ul>
              </div>
              <div className="bg-gray-900 p-6 rounded-lg">
