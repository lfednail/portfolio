...
export const workItems: WorkItem[] = [

  {
    ...
    description: 'J\'ai développé une application web pour le projet Nautilus Horizon. L\'application a été construite en utilisant Next.js et Tailwind CSS, offrant une interface moderne, réactive et performante.',
  ...
  },
  {
    ...
    description: 'Lors de mon stage au Conseil Départemental du Nord, j\ai intégré l\authentification SAML sur une plateforme WordPress pour sécuriser les accès utilisateurs. Mon rôle consistait à configurer et à déployer cette solution afin de renforcer la sécurité des connexions tout en assurant une expérience utilisateur fluide.' ,
  ...
  },
  {
    ...
    description: 'Lors de mon stage à la Caisse Nationale d’Assurance Maladie, j\'ai utilisé et appris à travailler avec VBA (Visual Basic for Applications). J\'ai créé une macro Word permettant de partager automatiquement un document sur SharePoint, optimisant ainsi le processus de gestion et de partage de documents au sein de l\'entreprise. ',
